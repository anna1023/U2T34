...
public class Bill {
   ...
   */
    public boolean addTip() {
        if (tipAdded == false){
            if (customers == 1){
                double tip = totalCost*0.2;
                totalCost += tip;
                tipAdded = true;
                return true;
            }
            if (customers >= 2 && customers < 4){
                double tip = totalCost*0.25;
                totalCost += tip;
                tipAdded = true;
                return true;
            }
            if (customers >= 4 && customers <8){
                double tip = totalCost*0.27;
                totalCost += tip;
                tipAdded = true;
                return true;
            }
            if (customers >= 8){
                double tip = totalCost*0.3;
                totalCost += tip;
                tipAdded = true;
                return true;
            }
